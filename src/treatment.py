...
class Treatment():
    ...
    def apply_treatment(self, preprocessed_data: pl.DataFrame, treated_groups: List[str]) -> pl.DataFrame:
        """
        ...
        """
        treated = pl.col(self.id_col).is_in(treated_groups)*pl.col(self.treatment_period_flag_col)
